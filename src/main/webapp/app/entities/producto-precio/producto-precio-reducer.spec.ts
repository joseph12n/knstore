...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOPRECIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTOPRECIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTOPRECIO actions', async () => {
      const arg = { id: 'd7e987d6-09e2-4532-86ef-ae3c429db40c' };
    ...
    it('dispatches UPDATE_PRODUCTOPRECIO actions', async () => {
      const arg = { id: 'd7e987d6-09e2-4532-86ef-ae3c429db40c' };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOPRECIO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PRODUCTOPRECIO actions', async () => {
      const arg = 42666;
