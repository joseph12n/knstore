...
import reducer, {
  ...
  reset,
  updateEntity,
} from './variante-producto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VARIANTEPRODUCTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VARIANTEPRODUCTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VARIANTEPRODUCTO actions', async () => {
      const arg = { id: '6841a0fc-3d74-4150-91ba-f50a1a1d416a' };
    ...
    it('dispatches UPDATE_VARIANTEPRODUCTO actions', async () => {
      const arg = { id: '6841a0fc-3d74-4150-91ba-f50a1a1d416a' };
    ...
    it('dispatches PARTIAL_UPDATE_VARIANTEPRODUCTO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_VARIANTEPRODUCTO actions', async () => {
      const arg = 42666;
