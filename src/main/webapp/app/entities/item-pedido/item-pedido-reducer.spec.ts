...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMPEDIDO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ITEMPEDIDO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ITEMPEDIDO actions', async () => {
      const arg = { id: 'beb24828-4189-4fe1-a0c9-baef1b302820' };
    ...
    it('dispatches UPDATE_ITEMPEDIDO actions', async () => {
      const arg = { id: 'beb24828-4189-4fe1-a0c9-baef1b302820' };
    ...
    it('dispatches PARTIAL_UPDATE_ITEMPEDIDO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ITEMPEDIDO actions', async () => {
      const arg = 42666;
