...
import HeroBanner from 'app/storefront/components/HeroBanner';
...
import { buildImageUrl } from 'app/storefront/utils/format';

interface StoreHomeProps {
  onAddToCart: (producto: IProductoStorefront, cantidad?: number) => void;
}

export const StoreHome = ({ onAddToCart }: StoreHomeProps) => {
  const {
