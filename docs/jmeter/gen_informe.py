...
<section id="rendimiento">
  ...
  <div class="card">
    ...
    <div class="note">Objetivos: RNF-007 (P95 &lt; 500 ms a nivel servidor) y RNF-024 (sin sobreventa). La <b>ronda 3</b> (limit): 547 hilos en total, incluidos 100 con arranque en 2 s y 150 con escalado gradual, más soak de 4 minutos: <b>99,92 % de éxito</b> (7 fallos por conexión cortada durante el soak, con recuperación inmediata).</div>
  </div>
  <div class="card">
