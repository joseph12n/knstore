...
const MODELOS = [
  { marca: 'Nike', categoria: 'Hombre', sub: 'Running', nombre: 'Air Zoom Pegasus 41', ref: 'NK-AZP41', venta: 479900, colores: ['Negro', 'Azul', 'Gris'], destacado: true },
  { marca: 'Nike', categoria: 'Unisex', sub: 'Casual', nombre: 'Air Force 1 07', ref: 'NK-AF107', venta: 449900, colores: ['Blanco', 'Negro'], destacado: true },
  { marca: 'Nike', categoria: 'Hombre', sub: 'Casual', nombre: 'Air Max 270', ref: 'NK-AM270', venta: 549900, colores: ['Negro', 'Rojo'], destacado: true },
  ...
  { marca: 'Nike', categoria: 'Hombre', sub: 'Fútbol', nombre: 'Mercurial Superfly 10', ref: 'NK-MSF10', venta: 899900, colores: ['Azul', 'Rojo'], destacado: true },
  { marca: 'Nike', categoria: 'Mujer', sub: 'Running', nombre: 'Air Zoom Pegasus 41 W', ref: 'NK-AZP41W', venta: 469900, colores: ['Rosa', 'Blanco'] },
  { marca: 'Nike', categoria: 'Mujer', sub: 'Casual', nombre: 'Air Max SC W', ref: 'NK-AMSCW', venta: 379900, colores: ['Blanco', 'Beige'] },

  { marca: 'Adidas', categoria: 'Hombre', sub: 'Running', nombre: 'Ultraboost 22', ref: 'AD-UB22', venta: 649900, colores: ['Negro', 'Gris'], destacado: true },
  { marca: 'Adidas', categoria: 'Unisex', sub: 'Casual', nombre: 'Samba OG', ref: 'AD-SAMBA', venta: 399900, colores: ['Negro', 'Blanco'], destacado: true },
  { marca: 'Adidas', categoria: 'Unisex', sub: 'Casual', nombre: 'Superstar', ref: 'AD-SUPER', venta: 349900, colores: ['Blanco', 'Negro'] },
  { marca: 'Adidas', categoria: 'Mujer', sub: 'Casual', nombre: 'Grand Court W', ref: 'AD-GCW', venta: 249900, colores: ['Blanco', 'Rosa'] },
  { marca: 'Adidas', categoria: 'Niño', sub: 'Running', nombre: 'Runfalcon 5', ref: 'AD-RF5', venta: 219900, colores: ['Azul', 'Negro'] },
  { marca: 'Adidas', categoria: 'Hombre', sub: 'Fútbol', nombre: 'Predator League FG', ref: 'AD-PRL', venta: 349900, colores: ['Negro', 'Verde'] },
  { marca: 'Adidas', categoria: 'Hombre', sub: 'Running', nombre: 'Adizero SL2', ref: 'AD-AZSL2', venta: 549900, colores: ['Blanco', 'Azul'] },

  { marca: 'Puma', categoria: 'Hombre', sub: 'Casual', nombre: 'RS-X Efekt', ref: 'PM-RSX', venta: 379900, colores: ['Negro', 'Gris'] },
  { marca: 'Puma', categoria: 'Unisex', sub: 'Casual', nombre: 'Suede Classic XXI', ref: 'PM-SUEDE', venta: 299900, colores: ['Negro', 'Rojo'], destacado: true },
  { marca: 'Puma', categoria: 'Niño', sub: 'Casual', nombre: 'Smash V2', ref: 'PM-SMASH', venta: 219900, colores: ['Blanco', 'Azul'] },
  { marca: 'Puma', categoria: 'Mujer', sub: 'Running', nombre: 'Velocity Nitro 3 W', ref: 'PM-VN3W', venta: 449900, colores: ['Rosa', 'Negro'] },
  { marca: 'Puma', categoria: 'Hombre', sub: 'Fútbol', nombre: 'Future 7 Play', ref: 'PM-FUT7', venta: 329900, colores: ['Azul', 'Blanco'] },
  { marca: 'Puma', categoria: 'Mujer', sub: 'Casual', nombre: 'Carina 2.0', ref: 'PM-CAR2', venta: 249900, colores: ['Blanco', 'Beige'] },

  { marca: 'Reebok', categoria: 'Unisex', sub: 'Casual', nombre: 'Classic Leather', ref: 'RB-CLASS', venta: 329900, colores: ['Blanco', 'Negro'] },
  ...
  { marca: 'New Balance', categoria: 'Unisex', sub: 'Casual', nombre: '574 Core', ref: 'NB-574', venta: 379900, colores: ['Gris', 'Azul Marino'], destacado: true },
  { marca: 'New Balance', categoria: 'Hombre', sub: 'Casual', nombre: '9060', ref: 'NB-9060', venta: 649900, colores: ['Gris', 'Beige'] },
  { marca: 'New Balance', categoria: 'Hombre', sub: 'Running', nombre: 'Fresh Foam 1080 v13', ref: 'NB-FF1080', venta: 799900, colores: ['Azul', 'Negro'] },
  { marca: 'New Balance', categoria: 'Mujer', sub: 'Casual', nombre: '327 W', ref: 'NB-327W', venta: 399900, colores: ['Blanco', 'Rosa'] },

  { marca: 'Vans', categoria: 'Unisex', sub: 'Skate', nombre: 'Old Skool', ref: 'VN-OLDSK', venta: 329900, colores: ['Negro', 'Azul Marino'], destacado: true },
  ...
  { marca: 'Converse', categoria: 'Unisex', sub: 'Casual', nombre: 'Chuck Taylor All Star High', ref: 'CV-CTA', venta: 289900, colores: ['Negro', 'Blanco'], destacado: true },
  { marca: 'Converse', categoria: 'Mujer', sub: 'Casual', nombre: 'Run Star Hike', ref: 'CV-RSH', venta: 449900, colores: ['Blanco', 'Negro'] },
  { marca: 'Converse', categoria: 'Unisex', sub: 'Casual', nombre: 'Chuck 70', ref: 'CV-C70', venta: 359900, colores: ['Beige', 'Verde'] },

  { marca: 'Asics', categoria: 'Hombre', sub: 'Running', nombre: 'Gel-Kayano 31', ref: 'AS-GK31', venta: 849900, colores: ['Azul', 'Negro'], destacado: true },
  { marca: 'Asics', categoria: 'Hombre', sub: 'Running', nombre: 'Gel-Nimbus 26', ref: 'AS-GN26', venta: 899900, colores: ['Blanco', 'Azul'] },
  { marca: 'Asics', categoria: 'Unisex', sub: 'Running', nombre: 'Novablast 5', ref: 'AS-NOVA5', venta: 649900, colores: ['Negro', 'Verde'] },
  ...
  { marca: 'Fila', categoria: 'Hombre', sub: 'Running', nombre: 'Double Bounce', ref: 'FL-DBLB', venta: 259900, colores: ['Azul', 'Negro'] },

  { marca: 'Under Armour', categoria: 'Hombre', sub: 'Running', nombre: 'Charged Assert 10', ref: 'UA-CA10', venta: 279900, colores: ['Negro', 'Gris'] },
  { marca: 'Under Armour', categoria: 'Hombre', sub: 'Running', nombre: 'Hovr Infinite 5', ref: 'UA-HI5', venta: 549900, colores: ['Azul', 'Blanco'] },
  { marca: 'Under Armour', categoria: 'Niño', sub: 'Running', nombre: 'Surge 4', ref: 'UA-SURG4', venta: 229900, colores: ['Azul', 'Rojo'] },

  { marca: 'Jordan', categoria: 'Unisex', sub: 'Baloncesto', nombre: 'Air Jordan 1 Low', ref: 'JD-AJ1L', venta: 599900, colores: ['Negro', 'Rojo'], destacado: true },
  { marca: 'Jordan', categoria: 'Hombre', sub: 'Baloncesto', nombre: 'Air Jordan 1 Mid', ref: 'JD-AJ1M', venta: 649900, colores: ['Blanco', 'Azul'] },
  { marca: 'Jordan', categoria: 'Hombre', sub: 'Baloncesto', nombre: 'Air Jordan 4 Retro', ref: 'JD-AJ4R', venta: 1199900, colores: ['Gris', 'Negro'], destacado: true },

  { marca: 'Skechers', categoria: 'Mujer', sub: 'Casual', nombre: "D'Lites Fresh Start", ref: 'SK-DLFS', venta: 279900, colores: ['Blanco', 'Rosa'] },
  { marca: 'Skechers', categoria: 'Hombre', sub: 'Running', nombre: 'Go Run Ride 11', ref: 'SK-GRR11', venta: 379900, colores: ['Negro', 'Azul'] },
  { marca: 'Skechers', categoria: 'Mujer', sub: 'Casual', nombre: 'Arch Fit Comfy Wave', ref: 'SK-AFCW', venta: 349900, colores: ['Beige', 'Negro'] },
];
...
async function asegurarSubcategorias(categorias) {
  ...
  for (const modelo of MODELOS) {
    ...
    resultado[clave] = existente?.id
      ? await update('/subcategorias', { ...body, id: existente.id })
      : await create('/subcategorias', body);
  }
