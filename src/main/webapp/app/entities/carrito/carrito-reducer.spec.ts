...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './carrito.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARRITO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARRITO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARRITO actions', async () => {
      const arg = { id: 'bef4699a-bc3f-4500-bc3a-b1401806407c' };
    ...
    it('dispatches UPDATE_CARRITO actions', async () => {
      const arg = { id: 'bef4699a-bc3f-4500-bc3a-b1401806407c' };
    ...
    it('dispatches PARTIAL_UPDATE_CARRITO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CARRITO actions', async () => {
      const arg = 42666;
