...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPODOCUMENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIPODOCUMENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIPODOCUMENTO actions', async () => {
      const arg = { id: '0b64e1c1-9b6a-42b0-95bc-7c92fc85346c' };
    ...
    it('dispatches UPDATE_TIPODOCUMENTO actions', async () => {
      const arg = { id: '0b64e1c1-9b6a-42b0-95bc-7c92fc85346c' };
    ...
    it('dispatches PARTIAL_UPDATE_TIPODOCUMENTO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TIPODOCUMENTO actions', async () => {
      const arg = 42666;
