...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIAIVA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CATEGORIAIVA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CATEGORIAIVA actions', async () => {
      const arg = { id: '23d02687-12b8-4548-a546-7c6fde34a13c' };
    ...
    it('dispatches UPDATE_CATEGORIAIVA actions', async () => {
      const arg = { id: '23d02687-12b8-4548-a546-7c6fde34a13c' };
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIAIVA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CATEGORIAIVA actions', async () => {
      const arg = 42666;
