...
import { faMapMarkerAlt, faShoppingBag, faUser } from '@fortawesome/free-solid-svg-icons';
        ...
        <Col md={4}>
          <Card className="h-100 text-center p-3">
            <Card.Body>
              ...
              <Link to="/account/settings" className="btn btn-outline-primary btn-sm mt-2">
                Editar perfil JHipster
              </Link>
            </Card.Body>
          </Card>
        </Col>
        <Col md={8}>
          ...
          <Card className="mt-4">
            <Card.Body>
              ...
              <Button variant="outline-primary" size="sm" className="mt-3" as={Link as any} to="/account/settings">
                Editar información
              </Button>
            </Card.Body>
          </Card>
