...
#   1) ejecuta la suite completa contra el despliegue (docs/jmeter/knstore_test_plan.jmx)
...
jmeter -n -t docs/jmeter/knstore_test_plan.jmx -l docs/jmeter/resultados.jtl \
