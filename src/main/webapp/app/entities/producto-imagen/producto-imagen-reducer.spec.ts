...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOIMAGEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTOIMAGEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTOIMAGEN actions', async () => {
      const arg = { id: 'e14203b5-d55e-4608-bfa5-2a8a135e03d5' };
    ...
    it('dispatches UPDATE_PRODUCTOIMAGEN actions', async () => {
      const arg = { id: 'e14203b5-d55e-4608-bfa5-2a8a135e03d5' };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOIMAGEN actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PRODUCTOIMAGEN actions', async () => {
      const arg = 42666;
