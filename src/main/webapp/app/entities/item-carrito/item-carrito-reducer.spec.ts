...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMCARRITO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ITEMCARRITO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ITEMCARRITO actions', async () => {
      const arg = { id: '6e0543e7-4111-4d47-944a-a59078176f94' };
    ...
    it('dispatches UPDATE_ITEMCARRITO actions', async () => {
      const arg = { id: '6e0543e7-4111-4d47-944a-a59078176f94' };
    ...
    it('dispatches PARTIAL_UPDATE_ITEMCARRITO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ITEMCARRITO actions', async () => {
      const arg = 42666;
