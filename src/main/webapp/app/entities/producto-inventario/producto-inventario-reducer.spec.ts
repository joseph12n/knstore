...
import reducer, {
  ...
  reset,
  updateEntity,
} from './producto-inventario.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOINVENTARIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTOINVENTARIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTOINVENTARIO actions', async () => {
      const arg = { id: '017b9382-71e4-4d94-a83c-0e1c8317185c' };
    ...
    it('dispatches UPDATE_PRODUCTOINVENTARIO actions', async () => {
      const arg = { id: '017b9382-71e4-4d94-a83c-0e1c8317185c' };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOINVENTARIO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PRODUCTOINVENTARIO actions', async () => {
      const arg = 42666;
