...
> **Última actualización:** 2026-09-15 — estados sincronizados con la verificación del código (todos los RF/RNF del alcance están implementados y con pruebas).
...
- [cite_start]**RF-033 Editar datos del perfil propio:** Ofrece interfaz para que el usuario edite sus datos. [cite: 228, 229] [cite_start]Estado: Implementado. [cite: 232]
...
- [cite_start]**RF-037 Crear dirección:** Permite registrar una nueva dirección de envío. [cite: 243] [cite_start]Estado: Implementado. [cite: 248]
- [cite_start]**RF-038 Listar direcciones propias:** Permite consultar direcciones registradas. [cite: 248] [cite_start]Estado: Implementado. [cite: 251]
- [cite_start]**RF-039 Editar dirección propia:** Permite al usuario editar sus direcciones. [cite: 251] [cite_start]Estado: Implementado. [cite: 256]
- [cite_start]**RF-040 Eliminar dirección propia:** Permite al usuario eliminar sus direcciones. [cite: 256, 257] [cite_start]Estado: Implementado. [cite: 261]
- [cite_start]**RF-041 Marcar dirección como predeterminada:** Permite designar una dirección como predeterminada. [cite: 261] [cite_start]Estado: Implementado. [cite: 265]

### [cite_start]Módulo de Carrito y Pedidos [cite: 265, 287]

- [cite_start]**RF-042 Agregar producto al carrito:** Permite añadir un producto al carrito o crear uno si no existe. [cite: 268, 269] [cite_start]Estado: Implementado. [cite: 274]
- [cite_start]**RF-043 Consultar carrito:** Permite consultar el contenido actual del carrito. [cite: 274] [cite_start]Estado: Implementado. [cite: 277]
- [cite_start]**RF-044 Modificar cantidad de item:** Permite actualizar la cantidad de un producto en el carrito. [cite: 277] [cite_start]Estado: Implementado. [cite: 281]
- [cite_start]**RF-045 Eliminar item del carrito:** Permite remover un producto específico. [cite: 281] [cite_start]Estado: Implementado. [cite: 284]
- [cite_start]**RF-046 Vaciar carrito:** Elimina todos los items del carrito. [cite: 284] [cite_start]Estado: Implementado. [cite: 287]
- [cite_start]**RF-047 Confirmar pedido (checkout):** Permite confirmar el carrito convirtiéndolo en pedido. [cite: 290] [cite_start]Estado: Implementado. [cite: 296]
- [cite_start]**RF-048 Cálculo automático del total:** Calcula el total a partir de la sumatoria de subtotales. [cite: 296] [cite_start]Estado: Implementado. [cite: 300]
- [cite_start]**RF-049 Cancelar pedido:** Permite cancelar un pedido en estado PENDING o CONFIRMED. [cite: 300, 301] [cite_start]Estado: Implementado. [cite: 306]
- [cite_start]**RF-050 Listar pedidos propios:** Permite consultar historial de pedidos. [cite: 306] [cite_start]Estado: Implementado. [cite: 309]
- [cite_start]**RF-051 Listar todos los pedidos:** Permite a Admin y Manager consultar todos los pedidos. [cite: 309] [cite_start]Estado: Implementado. [cite: 312]
- [cite_start]**RF-052 Actualizar estado del pedido:** Permite promover el pedido por sus diferentes estados. [cite: 312] [cite_start]Estado: Implementado. [cite: 316]
- [cite_start]**RF-053 Consultar detalle de un pedido:** Consulta detalle completo incluyendo relaciones. [cite: 316] [cite_start]Estado: Implementado. [cite: 319]

### [cite_start]Módulos de Pagos, Envíos y Facturación [cite: 319, 346, 373]

- [cite_start]**RF-054 Iniciar proceso de pago:** Inicia pago indicando el método. [cite: 323] [cite_start]Estado: Implementado. [cite: 328]
- [cite_start]**RF-055 Procesar resultado del pago:** Interactúa con la pasarela externa para procesar el pago. [cite: 328] [cite_start]Estado: Implementado. [cite: 332]
- [cite_start]**RF-056 Validar coherencia de pago:** Verifica que el monto del pago coincida con el pedido. [cite: 332, 333] [cite_start]Estado: Implementado. [cite: 336]
- [cite_start]**RF-057 Solicitar reembolso:** Permite al Admin iniciar un reembolso. [cite: 336] [cite_start]Estado: Implementado. [cite: 340]
- [cite_start]**RF-058 Consultar historial de pagos:** Permite al Admin consultar historial completo. [cite: 340] [cite_start]Estado: Implementado. [cite: 343]
- [cite_start]**RF-059 Consultar pago de pedido propio:** Permite al propietario consultar el estado de pago. [cite: 343] [cite_start]Estado: Implementado. [cite: 346]
- [cite_start]**RF-060 Crear envío para un pedido:** Permite a Admin y Manager crear registro de envío. [cite: 350] [cite_start]Estado: Implementado. [cite: 354]
- [cite_start]**RF-061 Asignar número de seguimiento:** Permite asignar número de tracking al envío. [cite: 354] [cite_start]Estado: Implementado. [cite: 357]
- [cite_start]**RF-062 Actualizar estado del envío:** Permite promover el envío entre estados logísticos. [cite: 357] [cite_start]Estado: Implementado. [cite: 362]
- [cite_start]**RF-063 Registrar devolución de envío:** Permite marcar envío como devuelto. [cite: 362, 363] [cite_start]Estado: Implementado. [cite: 366]
- [cite_start]**RF-064 Consultar tracking propio:** Permite consultar seguimiento del envío propio. [cite: 366] [cite_start]Estado: Implementado. [cite: 369]
- [cite_start]**RF-065 Listar envíos pendientes:** Permite listar envíos para apoyar logística. [cite: 369] [cite_start]Estado: Implementado. [cite: 372]
- [cite_start]**RF-066 Generar factura automáticamente:** Genera registro al completarse el pago. [cite: 375] [cite_start]Estado: Implementado. [cite: 379]
- [cite_start]**RF-067 Generar referencia única:** Produce identificador legible y único de factura. [cite: 379] [cite_start]Estado: Implementado. [cite: 382]
- [cite_start]**RF-068 Consultar factura propia:** Permite al propietario consultar su factura. [cite: 383] [cite_start]Estado: Implementado. [cite: 386]
- [cite_start]**RF-069 Listar facturas:** Permite a Admin y Manager consultar todas las facturas. [cite: 386] [cite_start]Estado: Implementado. [cite: 389]
...
- [cite_start]**RNF-023 Atomicidad del checkout:** Confirmación de pedido es una operación atómica. [cite: 452] [cite_start]Estado: Implementado. [cite: 455]
- [cite_start]**RNF-024 Concurrencia en operaciones de stock:** Manejo de solicitudes simultáneas contra el inventario. [cite: 455] [cite_start]Estado: Implementado. [cite: 458]
- [cite_start]**RNF-025 Auditoría de pagos y pedidos:** Modificaciones de estado generan registros con marca temporal. [cite: 458] [cite_start]Estado: Implementado. [cite: 460]
- [cite_start]**RNF-026 Precisión monetaria:** Cálculos utilizan tipos numéricos DECIMAL(10,2) o DECIMAL(12,2). [cite: 460, 461] [cite_start]Estado: Implementado. [cite: 465]

---

## 3. Requerimientos adicionales incorporados

> Origen: auditoría de código del 2026-08-22 y barrido del 2026-08-24. Detalle completo en `docs/01-ANALYSIS/REQUERIMIENTOS_PENDIENTES.md`.

### Búsqueda, rendimiento y experiencia de compra

- **RF-070 Filtros server-side en el buscador (categoría/marca):** El endpoint de búsqueda acepta `categoriaId` y `marcaId` y filtra en servidor; se eliminó el filtrado client-side. Estado: Implementado.
- **RF-071 Búsqueda por marca con `@DBRef`:** La búsqueda resuelve las marcas por nombre y combina sus ids en el `$or` de texto. Estado: Implementado.
- **RF-072 Ordenamiento por precio en servidor:** Campo denormalizado `Producto.precioVenta` sincronizado al guardar `ProductoPrecio`; `sort=precioVenta,asc|desc` funciona en catálogo y búsqueda. Estado: Implementado.
- **RF-073 Edición del perfil propio (RF-033):** `ProfilePage` guarda solo campos editables y el backend permite a `CLIENTE` editar su propia `Cuenta` sin mass-assignment. Estado: Implementado.
- **RF-074 Edición de Cuenta desde panel admin:** El PUT preserva relaciones nulas (`user`, `tipoDocumento`) y el frontend resuelve el usuario aunque no esté en la primera página. Estado: Implementado.
- **RF-075 Reintento de pago desde la UI:** Botón "Pagar ahora" en el detalle del pedido cuando el pago no está aprobado. Estado: Implementado.
- **RF-076 Pago incluido en el resultado del checkout:** `CheckoutResultDTO.pago` elimina la llamada redundante a `POST /api/pagos/iniciar`. Estado: Implementado.

### Rendimiento y seguridad de plataforma

- **RNF-027 Índice de texto MongoDB:** Migración `ProductoIndexesMigration` (order 007) crea `producto_search_text` sobre nombre, descripción y sku. Estado: Implementado.
- **RNF-028 Eliminación de consultas N+1:** Listados de `Pago/Envio/Factura`, ownership y relaciones de producto resueltos por lotes con `$in` sobre `@DBRef`. Estado: Implementado.
- **RNF-029 Paginación real del carrito:** Endpoint público `GET /api/productos/por-ids` (máx. 200 ids) consumido por `CartContext`. Estado: Implementado.
- **RNF-030 Consecutivos diarios atómicos:** Colección `secuencias` con `findAndModify` + `$inc`; formatos `PED-aaaaMMdd-000001` y `FE-000001`. Estado: Implementado.
- **RNF-031 Protección de `/management/prometheus`:** Endpoint restringido a `ADMIN`/`MANAGER`; export deshabilitado en producción. Estado: Implementado.
