...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './categoria.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ICategoria> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CATEGORIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CATEGORIA actions', async () => {
      const arg = { id: '92bba97a-bc5f-447d-8f7b-f24f8f70cac5' };
    ...
    it('dispatches UPDATE_CATEGORIA actions', async () => {
      const arg = { id: '92bba97a-bc5f-447d-8f7b-f24f8f70cac5' };
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CATEGORIA actions', async () => {
      const arg = 42666;
