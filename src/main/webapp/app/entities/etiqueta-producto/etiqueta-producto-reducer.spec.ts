...
import reducer, {
  ...
  reset,
  updateEntity,
} from './etiqueta-producto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETIQUETAPRODUCTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ETIQUETAPRODUCTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ETIQUETAPRODUCTO actions', async () => {
      const arg = { id: '6d75cc74-69ca-4209-b713-330dd440131f' };
    ...
    it('dispatches UPDATE_ETIQUETAPRODUCTO actions', async () => {
      const arg = { id: '6d75cc74-69ca-4209-b713-330dd440131f' };
    ...
    it('dispatches PARTIAL_UPDATE_ETIQUETAPRODUCTO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ETIQUETAPRODUCTO actions', async () => {
      const arg = 42666;
