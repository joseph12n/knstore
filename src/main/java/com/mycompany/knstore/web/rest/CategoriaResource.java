...
/**
 * REST controller for managing {@link com.mycompany.knstore.domain.Categoria}.
 */
@RestController
...
public class CategoriaResource {
    ...
    public ResponseEntity<CategoriaDTO> createCategoria(@Valid @RequestBody CategoriaDTO categoriaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/categorias/" + categoriaDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, categoriaDTO.getId()))
            .body(categoriaDTO);
    }
    ...
    public ResponseEntity<CategoriaDTO> updateCategoria(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, categoriaDTO.getId()))
            .body(categoriaDTO);
    }
    ...
    public ResponseEntity<CategoriaDTO> partialUpdateCategoria(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, categoriaDTO.getId())
        );
    }
