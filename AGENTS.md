...
- Actualizar este `AGENTS.md` cuando cambien decisiones arquitectónicas, roles, convenciones o requerimientos; mantener sincronizada la copia `docs/03-DOCUMENTACION/AGENTS.md`.
