...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBCATEGORIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBCATEGORIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBCATEGORIA actions', async () => {
      const arg = { id: 'b1253916-97d6-4dc2-8264-8ad6f6e2df6a' };
    ...
    it('dispatches UPDATE_SUBCATEGORIA actions', async () => {
      const arg = { id: 'b1253916-97d6-4dc2-8264-8ad6f6e2df6a' };
    ...
    it('dispatches PARTIAL_UPDATE_SUBCATEGORIA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_SUBCATEGORIA actions', async () => {
      const arg = 42666;
