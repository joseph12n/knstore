...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './marca.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARCA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MARCA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MARCA actions', async () => {
      const arg = { id: 'cbf789fc-5b7e-4b38-b159-a0ce81e16678' };
    ...
    it('dispatches UPDATE_MARCA actions', async () => {
      const arg = { id: 'cbf789fc-5b7e-4b38-b159-a0ce81e16678' };
    ...
    it('dispatches PARTIAL_UPDATE_MARCA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MARCA actions', async () => {
      const arg = 42666;
