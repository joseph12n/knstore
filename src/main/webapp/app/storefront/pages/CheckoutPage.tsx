...
import CheckoutStepper from 'app/storefront/components/CheckoutStepper';
import AddressCard from 'app/storefront/components/AddressCard';
...
export const CheckoutPage = ({ cartItems, onCheckoutComplete }: CheckoutPageProps) => {
