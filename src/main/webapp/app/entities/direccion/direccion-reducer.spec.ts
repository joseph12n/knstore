...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './direccion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIRECCION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIRECCION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIRECCION actions', async () => {
      const arg = { id: '66b6e6a1-7b61-4749-a664-bdddcd13cf27' };
    ...
    it('dispatches UPDATE_DIRECCION actions', async () => {
      const arg = { id: '66b6e6a1-7b61-4749-a664-bdddcd13cf27' };
    ...
    it('dispatches PARTIAL_UPDATE_DIRECCION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_DIRECCION actions', async () => {
      const arg = 42666;
